            ...
            <section className="restaurant-list section-b-space banner-section ratio3_2">
                <div className="container">
                    <div className="title restaurant-title w-border pb-0">
                        ...
                        <ul
                            className="nav nav-pills restaurant-tab tab-style2 w-100 border-0 m-0"
                            id="Tab"
                            role="tablist"
                        >
                                        ...
                                        <div className="vertical-product-body">
                                            ...
                                            <div className="location-distance d-flex align-items-center justify-content-between pt-sm-3 pt-2">
                                                ...
                                                <ul className="distance">
                                                    <li>
                                                        <i className="ri-map-pin-fill icon" /> 3.2 km
                                                    </li>
                                                    <li>
                                                        <i className="ri-time-fill icon" /> 25 min
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div className="vertical-product-box">
                                        ...
                                        <div className="vertical-product-body">
                                            ...
                                            <div className="location-distance d-flex align-items-center justify-content-between pt-sm-3 pt-2">
                                                ...
                                                <ul className="distance">
                                                    <li>
                                                        <i className="ri-map-pin-fill icon" /> 4 km
                                                    </li>
                                                    <li>
                                    ...
                                    <div className="vertical-product-box">
                                        <div className="vertical-product-box-img">
                                            <a href="menu-listing.html">
                                                <img
                                                    className="product-img-top w-100 bg-img"
                                                    src="assets/images/product/vp-13.png"
                                                    alt="vp-5"
                                                />
                                            </a>
                                        </div>
                                    ...
                                    <div className="vertical-product-box">
                                        <div className="vertical-product-box-img">
                                            <a href="menu-listing.html">
                                                <img
                                                    className="product-img-top w-100 bg-img"
                                                    src="assets/images/product/vp-14.png"
                                                    alt="vp16"
                                                />
                                            </a>
                                            <div className="offers">
                                        ...
                                        <div className="vertical-product-body">
                                            ...
                                            <div className="location-distance d-flex align-items-center justify-content-between pt-sm-3 pt-2">
                                                ...
                                                <ul className="distance">
                                                    <li>
                                                        <i className="ri-map-pin-fill icon" /> 3 km
                                                    </li>
                                                    <li>
                                                        <i className="ri-time-fill icon" /> 25 min
                                                    </li>
                                    ...
                                    <div className="vertical-product-box">
                                        ...
                                        <div className="vertical-product-box-img">
                                            <a href="menu-listing.html">
                                                <img
                                                    className="vertical-product-img-top w-100 bg-img"
                                                    src="assets/images/product/vp-15.png"
                                                    alt="vp-7"
                                                />
                                            </a>
                                            <div className="offers">
                                        ...
                                        <div className="vertical-product-body">
                                            ...
                                            <div className="location-distance d-flex align-items-center justify-content-between pt-sm-3 pt-2">
                                                ...
                                                <ul className="distance">
                                                    <li>
                                                        <i className="ri-map-pin-fill icon" /> 2.4 km
                                                    </li>
                                                    <li>
                                                        <i className="ri-time-fill icon" /> 20 min
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div className="vertical-product-box">
                                        ...
                                        <div className="vertical-product-box-img">
                                            <a href="menu-listing.html">
                                                <img
                                                    className="vertical-product-img-top w-100 bg-img"
                                                    src="assets/images/product/vp-16.png"
                                                    alt="vp-8"
                                                />
                                            </a>
                                            <div className="offers">
                                        ...
                                        <div className="vertical-product-body">
                                            ...
                                            <div className="location-distance d-flex align-items-center justify-content-between pt-sm-3 pt-2">
                                                ...
                                                <ul className="distance">
                                                    <li>
                                                        <i className="ri-map-pin-fill icon" /> 1.8 km
                                                    </li>
                                                    <li>
                                                        <i className="ri-time-fill icon" /> 12 min
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
